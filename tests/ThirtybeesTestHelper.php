...
class ThirtybeesTestHelper {
	...
	/**
	 * ThirtybeesTestHelper constructor.
	 *
	 * @param \Thirtybees\ThirtybeesTest|\Thirtybees\ThirtyBeesFullTest $thirtybees_test
	 */
	public function __construct( $thirtybees_test ) {
		$this->main_test    = $thirtybees_test;
		$this->wd           = $thirtybees_test->wd;
